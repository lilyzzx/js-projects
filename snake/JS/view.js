;(function() {
  ...
  View.prototype.setUpGrid = function () {
    this.$el.html("<h3 class='score'>Score: <div class='points'></div></h3><div class='pause-modal'>Paused</div><div class='new-game-modal'><p>Uh oh! You lose :(</p><p>Play again?<p></div>");
